...
class Dataset:
    ...
    def dividing_df(self):
        ...
        df_cash.to_csv("JIeJLMeHb's/lab4/datasets/output/df_cash.csv")
        df_no_cash.to_csv("JIeJLMeHb's/lab4/datasets/output/df_no_cash.csv")
        return(del_str)

def main():
    filename = "JIeJLMeHb's/lab4/datasets/var4.csv"
