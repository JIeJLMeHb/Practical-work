...
class Dataset:           #class to use
    ...
    def dividing_df(self):                    #func to divide into 2 dataframes
        ...
        df_cash.to_csv('programm_files/files_out/df_cash.csv')
        df_no_cash.to_csv('programm_files/files_out/df_no_cash.csv')
        return(del_str)


def main():
    filename = "programm_files/files_in/var4.csv"
